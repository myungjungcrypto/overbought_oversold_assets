...
매일 아침 07:30 KST에 측정해 한국어 리포트와 대시보드로 자동 발행하는,
...
| 주요 지수 | S&P500 · 나스닥 · 코스피 · 코스닥 · 닛케이225 · 항셍 · 필라델피아 반도체(SOX) |
...
`.github/workflows/daily.yml` 크론이 **매일 07:30 KST**(UTC 22:30)에 스캔·백테스트를 돌리고
결과를 `[skip ci]` 커밋으로 저장소에 남긴다. 수동 실행은 Actions 탭의 workflow_dispatch.
(Actions 크론은 최대 1시간가량 지연될 수 있다.)
